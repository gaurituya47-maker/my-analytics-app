...
st.info("💡 **Tips:** สถิติของ 'เหมยลี่ฟาง' มี Shelf Rate สูงกว่าเนื่องจากธรรมชาติของนิยายจีนโบราณที่คนมักดองไว้อ่านทีเดียว ส่วน 'minichiko' จะมี Engagement ในส่วนของคอมเมนต์ที่ Active กว่า")